...
{
    public class BrandTypeRepository : EFRepositoryBase<CleanArchitectureSampleDesingDbContext, BrandType>, IBrandTypeRepository
    {
        public BrandTypeRepository(CleanArchitectureSampleDesingDbContext context) : base(context)
        {
        }
    }
}

...
{
    public class ItemCatagoryRepository : EFRepositoryBase<CleanArchitectureSampleDesingDbContext, ItemCatagory>, IItemCatagoryRepository
    {
        public ItemCatagoryRepository(CleanArchitectureSampleDesingDbContext context) : base(context)
        {
        }
    }
}

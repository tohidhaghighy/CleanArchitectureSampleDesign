...
{
    public class OptionTypeRepository : EFRepositoryBase<CleanArchitectureSampleDesingDbContext, OptionType>, IOptionTypeRepository
    {
        public OptionTypeRepository(CleanArchitectureSampleDesingDbContext context) : base(context)
        {
        }
    }
}
